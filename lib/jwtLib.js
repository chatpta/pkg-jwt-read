...
const { throwLoginRequiredError } = require( "@chatpta/common-util" ).error;
...
function doesJwtUserHasRole( req, userRole, customErrorFunction ) {
...
function verifyJwtAndRole( role, publicKey, customErrorFunction ) {
    return async function ( req, res, next ) {
        await validateAndExtractJwtObject( req, publicKey, customErrorFunction )
            .then( req => doesJwtUserHasRole( req, role, customErrorFunction ) )
